...
export default function FloatingActionButton({ 
  ...
  const handleVoiceCommand = () => {
    ...
    // Simulate voice command duration
    if (!isListening) {
  ...
  return (
    <div className={`fixed ${bottomPosition} flex flex-col ${spacing} z-50`}>
      ...
      <Button
        ...
        title={isListening ? "Listening..." : isExpanded ? "Close Menu" : "Voice Commands"}
      >
      ...
      {isListening && (
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
          <div className="bg-dark-elevated border border-dark-border rounded-lg px-3 py-1 shadow-lg">
